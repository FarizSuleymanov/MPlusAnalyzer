...
import 'package:mplusanalyzer/pages/confront/confront_extra.dart';
...
import '../../reports/printpreview.dart';
import '../../reports/report_confront.dart';

class ConfrontPage extends StatefulWidget {
  const ConfrontPage({super.key});

  @override
  State<ConfrontPage> createState() => _ConfrontPageState();
}

class _ConfrontPageState extends State<ConfrontPage> {
  ...
  Future<void> setDocumentList() async {
    listDocuments_ = await Utils().getConfrontDocumentListForCurrentDay(
      context,
      selectedAgent,
    );
    ...
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ConfrontDoc(
          confrontData: doc,
          listClientCodesFromDocList: listClientCodesFromDocList,
        ),
      ),
    );
    setDocumentList();
  ...
  Future<void> print(dynamic doc) async {
    Uint8List pdf = await ReportConfront().getChequeDocument(document_: doc);
            ...
            Widgets().getSlideElement(
              ...
              () async {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ConfrontExtra(clientCode, clientName),
                  ),
                );
              },
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      AutoSlidingText(
                        text: documentData['clientName'].toString(),
                        style: TextStyle(
                          color: ThemeModule.cWhiteBlackColor,
                          fontSize: 14,
            ...
            title: Align(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    lan.getTranslatedText('confront'),
                    style: TextStyle(
                      fontFamily: 'poppins_medium',
                      fontSize: 20,
                      color: ThemeModule.cBlackWhiteColor,
